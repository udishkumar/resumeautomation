...
\section{\color{airforceblue}WORK EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \resumeItem{\normalsize{Developed high-performance FastAPI RESTful API resource, replacing MuleSoft; improved messaging latency by 35\% and boosted API throughput by 60\%, saving \$150K annually in licensing costs.}}
            \resumeItem{\normalsize{Built a consolidated Operational Data Store on AWS (RDS PostgreSQL and DynamoDB) with a FastAPI front-end, ingesting data from ResourceGuru, Greenhouse, and Zoho; cut data reconciliation efforts by 80\% and saved \$75K/year.}}  
            \resumeItem{\normalsize{Implemented CI/CD pipelines with Jenkins to automate build/test/deploy processes for Java and Python services; pushed release frequency to bi-weekly and lowered post-release defects by 50\%.}}  
      \resumeItemListEnd  
